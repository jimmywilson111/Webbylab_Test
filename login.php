...
<div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gradient-to-r from-black via-red-900 to-black">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 class="my-6 text-center text-3xl font-extrabold text-white">Login</h2>
    </div>
    ...
    <div class="my-8 mx-4 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 md:py-10 shadow rounded sm:px-10">
            ...
            <form class="space-y-6 md:m-4" method="POST" action="do_login.php">
                <!-- Login -->
                <div>
                    <label class="block font-medium text-sm text-gray-700" for="username">Email or Username</label>
                    <div class="mt-1">
                        <input id="username" class="appearance-none block w-full px-3 py-2 sm:text-sm border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-red-500 focus:border-red-500" type="text" name="username" placeholder="Enter your usernamer or email" required/ >
                    </div>
                </div>
                ...
                <div class="py-4">
                    <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Login</button>
                    ...
                    <a href="registration.php" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Sign Up</a>
                </div>
            </form>
        </div>
